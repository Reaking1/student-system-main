...
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH', __DIR__ . '/../../lib/font/');
...
// ✅ Corrected query: match your actual column names
$stmt = $pdo->prepare("
...
// ✅ Use Helvetica (built-in core font, no need for .php files)
